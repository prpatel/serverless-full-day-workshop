...
We suggest you spend a few minutes looking at the code (GetDBVersion.java) and some of the other classes in this exercise2 project.
...
* Examine the source code for the Cloud Functions under: exercise2/src/main/java/com/example/
* Open up the unit test: exercise2/src/test/java/com/example/CreateEngagementTest.java
...
```exercise2/src/main/resources/local.properties``` 
...
* Create a new bbject type to store to the database for a "person", follow the pattern in EngagementStore.java and the Engagement.java files. 
