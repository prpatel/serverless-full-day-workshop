...
import static com.cloudant.client.org.lightcouch.internal.CouchDbUtil.*;
...
public class DatabasePatch {
    ...
    static final Logger log = Logger.getLogger(DatabasePatch.class.getCanonicalName());
    private CouchDatabase db;
    private CloudantClient client;
    private  URI apiV2DBSecurityURI=null;
     ...
     */
    DatabasePatch(CloudantClient client, CouchDatabase db) {
        super();
        this.client = client;
        this.db = db;
     ...
     * @since 2.3.0
     */
    protected Database(DatabasePatch db) {
